...
class _AddImageScreenState extends State<AddImageScreen> {
  final homeScreenVM = Get.put(LocalImagesViewModel());
  @override
              ...
              child: Column(
                children: [
                  TextFormFieldComponent(
                    hintText: "title",
                    controller: homeScreenVM.titleController,
                    keyboardType: TextInputType.text,
                    focusNode: homeScreenVM.titleFocusNode,
                    validator: (value) {
                      if (value!.isEmpty) {
                    ...
                    onSubmited: (value) {
                      Utils.fieldFocusChange(
                        context,
                        homeScreenVM.titleFocusNode,
                        homeScreenVM.descriptionFocusNode,
                      );
                    },
                    onTapedOutside: (v) {
                      homeScreenVM.titleFocusNode.unfocus();
                    },
                  ),
                  10.verticalSpace,
                  TextFormFieldComponent(
                    hintText: "description",
                    controller: homeScreenVM.descriptionController,
                    keyboardType: TextInputType.text,
                    focusNode: homeScreenVM.descriptionFocusNode,
                    validator: (value) {
                      return null;
                    },
                    onSubmited: (value) {
                      homeScreenVM.descriptionFocusNode.unfocus();
                    },
                    onTapedOutside: (v) {
                      homeScreenVM.descriptionFocusNode.unfocus();
                    },
