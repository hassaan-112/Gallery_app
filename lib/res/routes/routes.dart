import 'package:gallery_app/bindings/homeVMBinding.dart';
import 'package:gallery_app/res/routes/routeNames.dart';
import 'package:gallery_app/view/bottomNav.dart';
import 'package:gallery_app/view/imageDetailScreen.dart';
...
import '../../view/lImageDetailScreen.dart';
...
class AppRoutes {
  static appRoutes() => [
    ...
    GetPage(name: RouteName.homeScreen, page: () { return BottomNavBar(); },binding: HomeScreenBinding(), transition: Transition.fadeIn,transitionDuration: Duration(seconds: 2)),
    ...
    GetPage(name: RouteName.LocalImageDetailScreen, page: () { return ImageDetailview(); },binding: HomeScreenBinding(), transition: Transition.fadeIn,transitionDuration: Duration(milliseconds: 1000)),
  ];
}
